on MacOS and Linux u should run the command `./run` after editing the `WORKING_DIR` to the path of the project and also allow the executable to run by executing `chmod +x run`.
